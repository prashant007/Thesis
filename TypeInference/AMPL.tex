...
\begin{center}
  ...
  \hline
    ...
    $\cal C~\bigg\{
                   \begin{array}[c]{l}
                   \big($~0$,\varepsilon~\mid~\varepsilon\big),\\
                   \big($-1$,{\sf g}(\varepsilon,\Gamma,\varepsilon,c_2):\varepsilon~\mid~\varepsilon:{\sf h}$(1)$\big)
                   \end{array}   
                \bigg\}
        $ &
        $\varepsilon$ &
    ...
    $\cal C~\bigg\{
                   \begin{array}[c]{l}
                   \big($~0$,\varepsilon~\mid~\varepsilon\big),\\
                   \big($-1$,{\sf g}(\varepsilon,\Gamma,v_1:\varepsilon,c_5):\varepsilon~\mid~\varepsilon:{\sf h}$(1)$\big)
                   \end{array}   
                \bigg\}
        $ &
        $\varepsilon$ &
...
\begin{center}
  ...
  \hline
    ...
    $\cal C~\bigg\{
                   \begin{array}[c]{l}
                   \big($~0$,\varepsilon~\mid~\varepsilon\big),\\
                   \big($-1$,v_1\texttt{+}v_2:\varepsilon~\mid~\varepsilon:{\sf h}$(2)$\big)
                   \end{array}   
                \bigg\}
        $ &
        $\varepsilon$ &
